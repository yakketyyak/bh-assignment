package io.blueharvest.technicalassignment.common.advice;


import io.blueharvest.technicalassignment.common.advice.error.ApiError;
import io.blueharvest.technicalassignment.common.advice.error.ErrorDetail;
import io.blueharvest.technicalassignment.common.exception.BusinessException;
import io.blueharvest.technicalassignment.common.exception.CommonsException;
...
public class RestErrorHandler {
    ...
    public ApiError processError(DuplicateResourceException exception, HttpServletRequest httpServletRequest) {
    ...
    public ApiError processError(AccessDeniedException exception, HttpServletRequest httpServletRequest) {
